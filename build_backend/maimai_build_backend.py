...
def build_sdist(sdist_directory: str, config_settings: dict | None = None) -> str:
    ...
    included_files = [
        ...
        "deploy/cloudflare/src/history-reader.js",
        "deploy/cloudflare/src/player-data.js",
        "deploy/cloudflare/src/report-stream.js",
        "deploy/cloudflare/test/player-data.test.mjs",
